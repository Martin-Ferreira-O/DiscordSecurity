export default {
	...
	commands: {
		help: {
			...
			noArgsDesc:
				'Puedes encontrar todos mis comandos en el siguiente formato, si necesita más información sobre cada comando, simplemente use d!help <Comando>',
		},
		invite: {
		...
		protected: {
			...
			noPerms:
				'Necesitas ser dueño del servidor para ejecutar este comando',
		...
		setup: {
			...
			respuestaSiNo:
				'Esto es una respuesta de si y no, intentalo denuevo',
			canalEnviar:
			...
			nobody: 'Ninguno',
			noMas3canales:
				'No puedes establecer mas de 3 canales para proteger.',
